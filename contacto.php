            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 pt-4 pt-sm-0 mb-5">
                    <form action="" method="POST">
                        <div>
                            <input type="text" name="txtNombre" id="txtNombre" placeholder="Nombre" class="form-control py-1.5 mb-3 shadow"> <!-- class de bootstrap form-control -->
                            <!-- shadow le da sombra al control contra el fondo -->
                        </div>
                        <div>
                            <input type="email" name="txtCorreo" id="txtCorre" placeholder="Correo" class="form-control py-1.5 mb-3 shadow"> <!-- class de bootstrap form-control -->
                            <!-- shadow le da sombra al control contra el fondo -->
                        </div>
                        <div>
                            <input type="tel" name="txtTelefono" id="txtTelefono" placeholder="Teléfono/Whatsapp" class="form-control py-1.5 mb-3 shadow"> <!-- class de bootstrap form-control -->
                            <!-- shadow le da sombra al control contra el fondo -->
                        </div>
                        <div>
                            <textarea name=”txtMensaje” id=”txtMensaje” cols="30" rows="6" placeholder="Escribe aquí tu mensaje" class="form-control py-1.5 mb-3 shadow"></textarea>
