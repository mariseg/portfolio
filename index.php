                ...
                <div class="collapse navbar-collapse" id="navbarCollapse" style>
                    ...
                    <form class="d-flex ms-4">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="en/index_en.html">EN</a>
                            </li>
                        </ul>
                    </form>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mt-sm-1 pt-sm-4 div-cohete">  <!-- clase text-center a la caja del cohete para despues darle alineacion center en CSS-->
                    <div>
                        <a href="proyectos.html"><img src="images/cohete.svg" alt="Proyectos" class="cohete"></a>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 text-center">  <!-- clase text-center a la caja del boton para despues darle alineacion center en CSS-->
                    <div>
                        <a href="proyectos.html"><button type="submit" name="btnEnviar" id="btnEnviar" class="btn px-3 shadow">Conoce mis
                            proyectos</button></a>
                    </div>
                </div>
            </div>
